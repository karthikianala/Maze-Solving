...
def solve(factory, method, output_file):
    ...
    """Create the maze (and time it) - for many mazes 
    this is more time consuming than solving the maze"""
    print ("Creating Maze")
    t0 = time.time()
    maze = Maze(im)
    t1 = time.time()
    ...
    drawing eithera horizontal or vertical line as required. Line colour
    is roughly interpolated between
